...
const FAQ_WEB = [
  ...
  { q: "Tu héberges aussi le site ?",
    a: "Oui. Hébergement rapide, SSL et sauvegardes quotidiennes, tout est inclus dans la maintenance à 59 $/mois, sans engagement. Le domaine (~15 $/an) reste à ton nom, et le site t'appartient : si tu veux partir, je te transfère tout proprement." },
  ...
  { q: "Et si je veux modifier le site après la mise en ligne ?",
    a: "Les ajustements du premier mois sont inclus dans le forfait. Ensuite : 50 $ par page modifiée, 200 $ pour une nouvelle page. Prix fixe, pas de taux horaire. Simple, transparent, sans surprise." },
