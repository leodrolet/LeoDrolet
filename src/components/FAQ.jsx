...
const FAQ_WEB = [
  ...
  { q: "Tu héberges aussi le site ?",
    a: "Oui. Hébergement rapide, SSL, sauvegardes quotidiennes et 30 min de modifications par mois, tout est inclus dans la maintenance à 59 $/mois, sans engagement. Le domaine (~15 $/an) reste à ton nom, et le site t'appartient : si tu veux partir, je te transfère tout proprement." },
  ...
  { q: "Et si je veux modifier le site après la mise en ligne ?",
    a: "Les ajustements du premier mois sont inclus dans le forfait. Ensuite, la maintenance à 59 $/mois couvre 30 min de modifications chaque mois, assez pour tenir tes prix, photos et services à jour. Pour du plus gros : 50 $ par page modifiée, 200 $ pour une nouvelle page. Simple, transparent, sans surprise." },
