  ...
  return (
    <section id="services" className="py-24 relative">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-px bg-white/5 rounded-2xl overflow-hidden border border-white/5 max-w-5xl mx-auto">
          {services.map((service, index) => (
            <motion.div
              ...
              className="flex items-start gap-4 p-7 bg-primary hover:bg-white/[0.025] transition-colors group"
            >
              <div className="w-8 h-8 flex-shrink-0 mt-0.5 text-accent/70 group-hover:text-accent transition-colors">
                {service.icon}
              </div>
              <div>
