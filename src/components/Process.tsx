        ...
        <div className="relative">
          ...
          <div className="grid md:grid-cols-3 gap-12 relative z-10">
            {steps.map((step, i) => (
              ...
              >
                <div className="w-20 h-20 rounded-3xl glass flex items-center justify-center mb-6 relative group cursor-pointer transition-all duration-300 hover:border-indigo-500/50">
                  <div className="absolute -top-2 -right-2 w-6 h-6 bg-indigo-500 rounded-full text-[10px] font-bold text-white flex items-center justify-center">
                    {step.step}
                  </div>
